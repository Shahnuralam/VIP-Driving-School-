            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="departure_info" id="departure_info" rows="2" 
                                  class="form-control @error('departure_info') is-invalid @enderror">{{ old('departure_info', $location->departure_info) }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="row">
                            @php 
                                $currentDays = old('available_days', $location->available_days ?? []);
                                // Handle if stored as JSON string
                                if (is_string($currentDays)) {
                                    $currentDays = json_decode($currentDays, true) ?? [];
                                }
                                // Normalize to lowercase for comparison
                                $currentDays = array_map('strtolower', $currentDays);
                            @endphp
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="day_{{ $day }}" 
                                           ...
                                           {{ in_array(strtolower($day), $currentDays) ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="available_days_text" id="available_days_text" 
                               ...
                               value="{{ old('available_days_text', $location->available_days_text) }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="map_embed_code" id="map_embed_code" rows="3" 
                                  class="form-control @error('map_embed_code') is-invalid @enderror">{{ old('map_embed_code', $location->map_embed_code) }}</textarea>
