        ...
        <div class="card-body">
            <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="lesson_count" id="lesson_count" min="1" 
                                       ...
                                       value="{{ old('lesson_count', $package->lesson_count) }}" required>
                                @error('lesson_count')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="lesson_duration" id="lesson_duration" min="1" 
                                       ...
                                       value="{{ old('lesson_duration', $package->lesson_duration) }}" required>
                ...
                <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="validity_days" id="validity_days" min="1" 
                                       ...
                                       value="{{ old('validity_days', $package->validity_days) }}" required>
                                @error('validity_days')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="validity_text" id="validity_text" 
                                       ...
                                       value="{{ old('validity_text', $package->validity_text) }}">
                                @error('validity_text')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1" {{ old('is_active', $package->is_active) ? 'checked' : '' }}>
